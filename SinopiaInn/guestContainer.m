...
@interface guestContainer ()

@end

@implementation guestContainer
...
-(void) gotoReservationpage {
    ...
    [self presentDetailController:[[reservationPage alloc] initWithHeight:(int)self.view.frame.size.width initWithWidth:(int)self.view.frame.size.height - (HomePageToolbar.frame.size.height )]];
...
-(void) gotoPayment {
    ...
    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:@"http://www.sinopiainn.com/api/checkout/"] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            _braintreeClient = [[BTAPIClient alloc] initWithAuthorization:clientToken];
            
            BTDropInViewController *dropInViewController = [[BTDropInViewController alloc]
                                                            initWithAPIClient:_braintreeClient];
...
-(void) returnedroomsArray:(NSArray*)jsonArray {
    ...
    [self presentDetailController:[[reservationPage alloc] initWithHeight:(int)self.view.frame.size.width initWithWidth:(int)self.view.frame.size.height - (HomePageToolbar.frame.size.height ) initWithFrom:fromdate initWithTo:todate initWithrooms:str_rooms initWithamenities:str_amenities]];
