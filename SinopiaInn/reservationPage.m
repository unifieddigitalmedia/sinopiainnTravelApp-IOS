...
- (id)initWithHeight:(int)theheight initWithWidth:(int)thewidth initWithFrom:(NSString*)fromdate initWithTo:(NSString*)todate initWithrooms:(NSString*)rooms initWithamenities:(NSString*)amenities {
